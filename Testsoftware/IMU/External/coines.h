 ...
 *
 * @param[out] temp_conv_data       :  Buffer to retrieve the sensor data in °C.
 *
 * @return Result of API execution status
 * @retval 0 -> Success
 * @retval Any non zero value -> Fail
 ...
 *
 */
int8_t coines_i2c_set(uint8_t dev_addr, uint8_t *data, uint8_t count);
 ...
 *
 */
int8_t coines_i2c_get(uint8_t dev_addr, uint8_t *data, uint8_t count);
